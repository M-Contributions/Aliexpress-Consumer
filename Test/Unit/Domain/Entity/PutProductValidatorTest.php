...
use Ticaje\AliexpressConsumer\Domain\Entity\Request\Validator\Product\Put as PutProductValidator;
use Ticaje\AliexpressConsumer\Domain\Interfaces\Entity\RequestValidatorInterface;

/**
 * Class PutProductValidatorTest
 * @package Ticaje\AliexpressConsumer\Test\Unit\Domain\Entity
 */
class PutProductValidatorTest extends ParentClass
{
    protected $class = PutProductValidator::class;
    ...
    public function testProperRequest()
    {
        ($prepareRequest = function () use (&$request) {
            ...
            $request->setContent((new PutProductRequestContainer())->getCompliantContent());
    ...
    public function testBadRequest()
    {
        ($prepareRequest = function () use (&$request) {
            $request = new ServiceRequestDto();
            $request->setContent((new PutProductRequestContainer())->getUnCompliantContent());
            $this->assertInstanceOf(RequestDtoInterface::class, $request, 'Assert proper object passed as argument');
        })();
...
/**
 * Class PutProductRequestContainer
 * @package Ticaje\AliexpressConsumer\Test\Unit\Domain\Entity
 */
class PutProductRequestContainer
{
